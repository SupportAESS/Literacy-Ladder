...
const ViewBooks = async (req, res) => {
  try {
    ...
    const { searchBy, bookName, author, minPrice, maxPrice, genre } = req.body;
    ...
    if (searchBy === "AllBooks") {
      ...
      query.bookPrice = { $gte: minPrice, $lte: maxPrice };
      console.log("Searching by book price range:", minPrice, "-", maxPrice);
